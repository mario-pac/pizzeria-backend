...
export const handleUpdateEmployee = async (
  ...
  return await new Promise<{ message: string }>((resolve, reject) => {
    axios
      .put(backendUrl + "/updateEmployee", body, {
        headers: {
          Authorization: token,
        },
      })
...
export const handleUpdateProduct = async (
  ...
  return await new Promise<{ message: string }>((resolve, reject) => {
    axios
      .put(backendUrl + "/updateProduct", body, {
        headers: {
          Authorization: token,
        },
      })
      ...
      .catch((error) => {
        reject(
          "Erro ao atualizar produto:" + (error as AxiosError).response?.data
        );
      });
  });
};
...
export const handleUpdateOrder = async (
  ...
  return await new Promise<{ message: string }>((resolve, reject) => {
    axios
      .put(backendUrl + "/updateOrder", body, {
        headers: {
          Authorization: token,
        },
      })
      ...
      .catch((error) => {
        reject(
          "Erro ao atualizar pedido:" + (error as AxiosError).response?.data
        );
      });
  });
};
...
export const handleUpdateOrderItem = async (
  ...
  return await new Promise<{ message: string }>((resolve, reject) => {
    axios
      .put(backendUrl + "/updateOrderItem", body, {
        headers: {
          Authorization: token,
        },
      })
